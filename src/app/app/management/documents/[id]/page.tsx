    ...
    <div>
      ...
      <div className="mx-auto max-w-3xl space-y-12">
        ...
        <article className="space-y-5">
          <Doc.Header title="Residential Tenancy Agreement" subtitle="South Australia" />
          ...
          <Doc.Section title="5. Bond">
            ...
            <Doc.Row label="Lodged with CBS" value={tenancy.bond_lodged ? "Yes" : "No"} />
          ...
          <p className="border-t border-neutral-300 pt-4 text-xs text-neutral-500">
            ...
            complete all blanks. This is not legal advice — confirm against the current SA Residential
            Tenancies Act and CBS requirements before signing.
          </p>
        </article>
        ...
        <article className="space-y-5 break-before-page">
          ...
          <Doc.Prose title="Inspections">
            Routine inspections are carried out up to 4 times a year with 7–28 days&apos; written notice,
            between 8am–8pm and never on a Sunday or public holiday. We&apos;ll always give you proper
            notice and confirm a time.
          </Doc.Prose>
